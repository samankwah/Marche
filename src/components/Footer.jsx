...
const Footer = () => {
  return (
    <>
      <footer className="container mx-auto mt-28 grid grid-cols-1 space-y-10 bg-[#48C4A0] px-5 py-8 tracking-wider text-white md:mt-28 md:grid-cols-4 md:space-y-0 xl:px-28 xl:py-20 ">
        {/* Shoptik */}
        <section className="space-y-4">
          <h1 className="text-4xl font-black tracking-wider">Marché.</h1>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4 text-sm font-light">
            ...
            <p className="flex items-center space-x-1">
              ...
              <span> 7 Mboumu St, GA-303-0722, Accra</span>
            </p>
